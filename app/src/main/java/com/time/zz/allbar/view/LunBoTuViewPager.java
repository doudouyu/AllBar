package com.time.zz.allbar.view;
...
/**
 * ccb on 2016/7/9.
 * 无限循环的viewpager 控件只需要继承即可
 * 使用时添加setitem这个方法 设置为1
 */
public class LunBoTuViewPager extends ViewPager {
    public LunBoTuViewPager(Context context) {
        super(context);
    }

    public LunBoTuViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
